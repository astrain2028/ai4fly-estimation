...
misspecification. Gupta and Guven [3] augment a Kalman filter with a neural
measurement model for UAV tracking in degraded sensing; de Curtò and de Zarzà
[4] combine a physics-informed network with an adaptive UKF. Both show a
learned map absorbing structure a hand-specified model omits.
...
degenerate solution documented by Seitzer et al. [5]. Immer et al. [6] avoid
...
indicate it is extrapolating. Ovadia et al. [7] show this is the expected
...
distributional score in the manner of Hendrycks and Gimpel [8] suffices, is
...
of a broader capability: Israelsen et al. [11] treat competency
...
Filter consistency is the primary criterion, following Chen et al. [9, 10]:
...
[3] A. Gupta and E. Guven, "Neural Aided Kalman Filtering for UAV State
Estimation in Degraded Sensing Environments," arXiv:2604.28107.

[4] J. de Curtò and I. de Zarzà, "Hybrid State Estimation: Integrating
...
[5] M. Seitzer, A. Tavakoli, D. Antic, and G. Martius, "On the Pitfalls of
...
[6] A. Immer, E. Palumbo, A. Marx, and J. Vogt, "Effective Bayesian
Heteroscedastic Regression with Deep Neural Networks," *Advances in Neural
Information Processing Systems 36*, 2023.

[7] Y. Ovadia et al., "Can You Trust Your Model's Uncertainty? Evaluating
...
[9] Z. Chen, C. Heckman, S. Julier, and N. Ahmed, "Weak in the NEES?:
Auto-tuning Kalman Filters with Bayesian Optimization," 2018.
[arXiv:1807.08855](https://arxiv.org/abs/1807.08855)

[10] Z. Chen, H. Biggie, N. Ahmed, S. Julier, and C. Heckman, "Kalman Filter
...
[11] B. W. Israelsen, N. R. Ahmed, M. Aitken, E. W. Frew, D. A. Lawrence, and
